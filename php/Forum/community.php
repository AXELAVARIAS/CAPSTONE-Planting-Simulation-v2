                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="discussion-item list-group-item new-discussion-layout">
                        <div class="discussion-avatar">
                          <img src="<?= (empty($row['profile_picture']) || $row['profile_picture'] === 'clearteenalogo.png') 
                              ? '../../images/clearteenalogo.png' 
                              : '../../images/profile_pics/' . htmlspecialchars($row['profile_picture']) ?>" alt="User Avatar" onerror="this.onerror=null;this.src='../../images/clearteenalogo.png'">
                        </div>
